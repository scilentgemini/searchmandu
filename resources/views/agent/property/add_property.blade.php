                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="file" name="multi_img[]" class="form-control" id="multiImg"
                                                multiple="" accept=".jpg, .jpeg, .png, image/heic, image/heif">
                              ...
                              <div class="col-sm-12">
                                ...
                                <div class="row add_item">
                                    ...
                                    <div class="form-group col-md-4" style="padding-top: 30px;">
                                        <a class="btn btn-info addeventmore"><i class="fa fa-plus-circle"></i> Add
                                            More</a>
                                    </div>
                                </div> <!---end row-->
